...
//  2. Six options per question, mapped to different learning styles (MI). Because
//     only one option can be picked, the six-per-question spread provides breadth
//     in strength attribution without artificially inflating interest scores.
//  3. Every option carries one mi_* signal (learning style) and one strength_signal.
//     Interest signals (riasec_X) were removed after discovery that a single
//     ice-breaker pick scored an interest 100, making warm-up decisions dominate
//     the 14-item interest questionnaire that follows. Strengths and learning
//     styles are preserved — both serve the character creation and dashboard.
...
export const warmupQuestions: Question[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        value: 2,
        emoji: "🔍",
        framework_signals: { mi_logical: 1 },
      ...
      },
      {
        ...
        value: 3,
        emoji: "🎨",
        framework_signals: { mi_spatial: 1 },
      ...
      },
      {
        ...
        value: 4,
        emoji: "🤝",
        framework_signals: { mi_interpersonal: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        value: 3,
        emoji: "💡",
        framework_signals: { mi_intrapersonal: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        value: 5,
        emoji: "🗣️",
        framework_signals: { mi_linguistic: 1 },
...
export const riasecLikertQuestions: Question[] = [
  // Realistic (R)
  {
    ...
    options: [
      ...
      { label: "Dislike", value: 2, emoji: "😕" },
      { label: "Like", value: 3, emoji: "🙂" },
      { label: "Strongly Like", value: 4, emoji: "🤩" },
    ],
    reverse_scored: false,
    framework: "riasec",
    framework_target: "R",
